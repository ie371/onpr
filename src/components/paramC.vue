        ...
        <div class='col-md-3'>
            ...
            <div class="form-group">
                <div class='col'>
                    ...
                    <multiselect v-model="plats" 
                    :options="options" :multiple="true" track-by="lib" :custom-label="customLabel"
        ...
        <div class='col-md-3 px-3 border-left border-warning'>
            ...
            <div class='form-group'>
                ...
                <div class="form-row">
                    <div class='col'>
                        ...
                        <select class='form-control form-control-sm' v-model="isx.sx_ot" 
            ...
            <div class='form-group'>
                ...
                <div class="form-row mb-2">
                    ...
                    <div class='col'>
                        <input type='number' class='form-control form-control-sm' placeholder='T1' v-model="isx.t1"
                            v-on:input="proj('')"
                            step='0.1' oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                            maxlength="5">
                    </div>
                    <div class='col'>
                ...
                <div class="form-row mb-2">
                    ...
                    <div class='col'>
                        <input type='text' class='form-control form-control-sm' v-model="select_T2.dim" disabled>
                    </div>
                </div>
                ...
                <div class="form-row mb-2">
                    ...
                    <div class='col'>
                        <input type='text' class='form-control form-control-sm' v-model="this.select_T2.im" disabled>
                    </div>
                </div>
                <div class="form-row mb-2">
                    <div class='col'>
                    ...
                    <div class='col'>
                        <input type='number' class='form-control form-control-sm' v-model="this.select_T2.dtr" disabled>
                ...
                <div class="form-row">
                    <div class='col'>
                        ...
                        <select class='form-control form-control-sm' v-model="isx.tipLg" :class="{'red-error' : ml.g }"
                            @change="proj('qmax')" id='mlg' :disabled="stup">
                            <option value='kl'>Классическая</option>
                            <option value='ml'>Модифицированная</option>
                        </select>
        ...
        <div class='col-md-3 px-3 border-left border-warning'>
            ...
            <div class='d-flex justify-content-center'>
                ...
                <div class='col-md-9'>
                    ...
                    <b-btn type='submit' variant="primary" formaction='./pdf/project/kp.php' :disabled="disButKP ? true : false"
...
export default {
            ...
            if(this.isx.pr_ot !==0){
                ...
                if(this.isx.tipLo === 'ml'){
                    ...
                    if(this.isx.sx_ot > 0){
                        ...
                        } else { this.pozOtisx.filtr9.col = 0 }
    ...
    methods: {
        ...
        proj(m,u) {
            ...
            if (u) {  this.$store.dispatch('change_tip_im4', this.isx.tipIMg3) }
