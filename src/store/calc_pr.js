...
function gidr(  t, du_im, du_tr, Gm,  p,  tipL, Gg,  tg, pg, otpen, filtr, ok, tipIM ) {
    ...
    if(tipL==='kl'){ 
        ...
        if(tipIM===6){  var L = alfaAr[ki].li6 } else { var L = alfaAr[ki].lk5 }
    } else if (tipL==='ml'){ 
        var alfa = alfaAr_mod[ki].alf;
        if(alfa) { var alf = alfa; } else { var alf = 0; }
        if(tipIM===6){  var L = alfaAr_mod[ki].li6 } else { var L = alfaAr_mod[ki].lk5 }
    }
   ...
   if(alf === 0){ 
    ...
    var Ptrmestn = 20 * Math.pow(poter_kr, 2) +  10 * Math.pow(poter_ok, 2) +  10 * Math.pow(poter_fil, 2) + Math.pow(poter_grz/(2 * 9.81), 2);
...
if(tip_rascheta != 'gvs'){
        if( isx.qco > 0 ){
                ...
                if(+isx.sx_otkr > 0){
                            ...
                            var gg1 =+Gg.Gm3;
                            if( isx.sx_gvs > 0 ){  gg2 = 0; } else { var gg2 =+Gg.Gm4; }
                ...
                if(isx.sx_ot > 0){
                    ...
                    var gdr9 = gidr( t2, DUim9, duTr9, Gm9, p2, tipL, null, null, null, 0, 0, 0, 5  );
                } else {
